...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "GTech Fantasy" },
      { name: "description", content: "GTech Fantasy — premium Telegram mini app. Play, earn, win GTC." },
      { property: "og:title", content: "GTech Fantasy" },
      { name: "twitter:title", content: "GTech Fantasy" },
      { property: "og:description", content: "GTech Fantasy — premium Telegram mini app. Play, earn, win GTC." },
      { name: "twitter:description", content: "GTech Fantasy — premium Telegram mini app. Play, earn, win GTC." },
